            ...
            <div className="px-6 py-3">
              <div className="flex items-center justify-between mb-3">
                <h3 className="font-medium text-sm">
                  {chunkTotal > 0
                    ? t('chat.chunksPanel.headingRange', {
                        from: chunkOffset + 1,
                        to: chunkOffset + chunks.length,
                        total: chunkTotal
                      })
                    : t('chat.chunksPanel.heading', { count: chunkTotal })}
                </h3>
                <div className="flex items-center gap-1">
                  <Button
                    ...
                    aria-label={t('chat.chunksPanel.prevPageAriaLabel')}
                  >
                  ...
                  <Button
                    ...
                    aria-label={t('chat.chunksPanel.nextPageAriaLabel')}
                  >
